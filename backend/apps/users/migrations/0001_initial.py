    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("forwarding_address", models.EmailField(max_length=254, unique=True)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("user", "sender_email"), name="unique_user_sender_email"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider_type",
                    models.CharField(
                        choices=[("llm", "LLM"), ("email_inbound", "Email Inbound")],
                        max_length=20,
                    ),
                ),
                (
